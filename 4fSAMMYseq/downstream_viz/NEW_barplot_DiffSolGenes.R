...
plot_gene_counts(folder = folder, pattern = "S2LvsS3", pdf_file = "./plots/diffsoluble_gene_counts_S2LvsS3.pdf")
plot_gene_counts(folder = folder, pattern = "S2SvsS4", pdf_file = "./plots/diffsoluble_gene_counts_S2SvsS4.pdf")
plot_gene_counts(folder = folder, pattern = "S4vsS3", pdf_file = "./plots/diffsoluble_gene_counts_S4vsS3.pdf")