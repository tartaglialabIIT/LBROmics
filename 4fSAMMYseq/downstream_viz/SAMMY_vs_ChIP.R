...
#  H3K9me3 = "./bonev_bigWig/GSE96107_NPC_Ring1B.bw",
...
pdf(paste0(out_prefix, "_panelA_chr6_region.pdf"), width = 16, height = 6)
...
pdf(paste0(out_prefix, "_panelB_correlation_alltracks.pdf"), width = 7, height = 6)
...
# Plot heatmap
pdf(paste0(out_prefix, "_panelB_correlation_heatmapH3K27me3.pdf"), width = 6, height = 5)
pheatmap(corr_sub,
         color = my_colors,
         cluster_rows = FALSE,
         cluster_cols = FALSE,
